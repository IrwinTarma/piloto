<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-4 {{ $errors->has('nTdocCod') ? 'has-error' :'' }}">
            {!! Form::text('$tcliente->tipodoc->cTdocSigla', null, ['class' => 'form-control', 'placeholder'=>'Tipo de Doc.', 'disabled']) !!}
            {!! $errors->first('nTdocCod','<span class="help-block">:message</span>') !!}
        </div> 
